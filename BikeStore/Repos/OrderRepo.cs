...
namespace BikeStore.Repos
{
	public class OrderRepo : BaseRepo<Order>
	{
		...
		public override List<Order> GetRange<TSortField>(Expression<Func<Order, TSortField>> orderBy, Expression<Func<Order, bool>> where, int skip, int take, bool ascending = true)
		{
